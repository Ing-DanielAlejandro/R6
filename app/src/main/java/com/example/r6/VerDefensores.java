...
public class VerDefensores extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DbOperadores dbOperadores = new DbOperadores(VerDefensores.this);
        listaArrayOperadores = new ArrayList<>();
        listaOperadoresAdapter adapter = new listaOperadoresAdapter(dbOperadores.mostrarOperadoresDef());
